...
<html>
    ...
    <body style='background-color: #003366'>  
        ...
        <center><h1 style='color:white;font-family:verdana'>Ballot - Empire Of Okanagan</h1></center>
        <hr>

        <center><h2 style='color:white;font-family:verdana'><form name="user" form action="setResults.php" onsubmit="return validateName()" method="post">
            ...
            function validateName(){
                var x=document.forms["user"]["names"].value;
